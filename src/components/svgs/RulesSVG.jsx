...
export default function RulesSVG() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="304" height="270">
            ...
            <g fill="none" fillRule="evenodd">
                ...
                <text fill="#B1B4C5" fontFamily="BarlowSemiCondensed-Bold, Barlow Semi Condensed" fontSize="13" fontStyle="condensed" fontWeight="bold">
